...
<div class="wrapper">
 ...
 <div class="content-wrapper">
  ...
  <form action="../handlers/add_exam.php" method="post">
                <div class="form-group">
                    <label for="exampleFormControlInput1">Exam Name</label>
                    <input type="text" name="eName" class="form-control" id="exampleFormControlInput1">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Exam Date</label>
                    <input type="date" name="eDate" class="form-control" id="exampleFormControlInput1">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Start Time</label>
                    <input type="time" name="eStartT" class="form-control" id="exampleFormControlInput1">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">End Time</label>
                    <input type="time" name="eEndT" class="form-control" id="exampleFormControlInput1">
                </div>
