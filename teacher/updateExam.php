...
<div class="wrapper">
 ...
 <div class="content-wrapper">
  ...
  <form action="../handlers/update_exam.php" method="post">
                <div class="form-group">
                    <label for="exampleFormControlInput1">Exam Name</label>
                    <input type="text" name="eName" class="form-control" id="exampleFormControlInput1" value="<?=$_SESSION['eName']?>">
                   
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Exam Date</label>
                    <input type="date" name="eDate" class="form-control" id="exampleFormControlInput1" value="<?=$_SESSION['eDate']?>">
                    
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Start Time</label>
                    <input type="time" name="eStartT" class="form-control" id="exampleFormControlInput1" value="<?=$_SESSION['eStartT']?>">
                   
                </div>
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">End Time</label>
                    <input type="time" name="eEndT" class="form-control" id="exampleFormControlInput1" value="<?=$_SESSION['eEndT']?>">
                    
                </div>

                <button type="submit" class="btn btn-primary w-25">Edit</button>
                <a href="../coursePage.php" class="btn btn-primary w-25">Return</a>
       </form>
  </div>
</div>
