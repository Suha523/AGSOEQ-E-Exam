<?php
 ...
 include("handlers/show_grades.php");
      ...
      <div class="container">
        <div class="card">
         ...
         if(mysqli_num_rows($query)==0){?>
            <div class="card">
               <h4 class="card-header text-danger"><?php echo "No Grades To Show"?> </h4>
           </div>
         <?php
                      ...
                      <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                        ...
                        <tbody>
                            <?php
                                ...
                                <td rowspan="1" colspan="1"><?=$student['stuId']?></td>
                                <td rowspan="1" colspan="1"><?=$student['fName']?> <?=$student['lName']?> </td>
                                <td rowspan="1" colspan="1"><?=$student['eMark']?></td>
                                <td rowspan="1" colspan="1"><?=$_SESSION['totalMark']?></td>
                        ...
                        <tfoot>
                            <tr class="text-center">
                                ...
                                <th rowspan="1" colspan="1">Student Mark</th>
              ...
              <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                ...
                <tbody>
                    <?php
                        ...
                        <td rowspan="1" colspan="1"><?=$grade['14']?> </td>
                        <td rowspan="1" colspan="1"><?=$grade['7']?></td>
                        <td rowspan="1" colspan="1"><?=$grade['15']?></td>
                ...
                <tfoot>
                    <tr class="text-center">
                        ...
                        <th rowspan="1" colspan="1">Exam Name</th>
                        <th rowspan="1" colspan="1">Student Mark</th>
                        <th rowspan="1" colspan="1">Total Mark</th>
                    </tr>
                </tfoot>
